...
const Technology = () => {
  ...
  useEffect(() => {
   ...
   axios.get("https://reactprojectbackend.herokuapp.com/api/v1/technology").then((res) => {
     const data = res.data;
     setstate(data);
     setLoading(false)
   });
  ...
  return (
      ...
      <div className='tourism'><br/><br/><br/><br/>
        <div className='subheading'><h1>Technology</h1><hr/></div><br/><br/><hr className='line'/><br/>
      <div className='box-2'>
